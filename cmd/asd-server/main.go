...
import (
	...
	"github.com/torabian/testapp/cmd/asd-server/menu"
)

var PRODUCT_NAMESPACENAME = "asd"
var PRODUCT_DESCRIPTION = "asdsad"
...
var xapp = &workspaces.FirebackApp{
	...
	SeedersSync: func() {
		...
		workspaces.AppMenuSyncSeederFromFs(
			&menu.Menu,
			[]string{"new-menu.yml"},
			workspaces.QueryDSL{WorkspaceId: "system"},
		)
	},
	RunTus: func() {
